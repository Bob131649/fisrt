...
def eval_value(policy, buffer_expert, buffer_random, sample_size=1500, mode='q'):
    ...
    if mode == 'q':
        ...
        value_random = policy.get_pi_q(state_random, policy.qnet, policy.actor_vae, use_noise=False)
        value_expert = policy.get_pi_q(state_expert, policy.qnet, policy.actor_vae, use_noise=False)
    if mode == 'v':
...
if __name__ == "__main__":
    ...
    if args.mode != 'pi' or args.load_model != -1:
            ...
            if args.mode == 'v':
                ...
                with tqdm(range(args.eval_freq), desc='Batch', leave=False) as tepoch:
                    for idx in tepoch:
                        ...
                        state_random_inr, _, _, _, _ = batch_random
                        state_expert_ine, _, _, _, _ = batch_expert
                        ...
                        v_loss, v_random, v_expert = policy.train_value(state_random_inr, state_expert_inr, state_expert_ine)
...
# python train_reference_v2.py --ExpID 1 --env_name antmaze-large-diverse-v2 --plot --mode pi --device cuda:1
# python train_reference_v2.py --ExpID 100 --env_name antmaze-large-diverse-v2 --plot --mode v --device cuda:1 --load_model 3
# python train_reference_v2.py --ExpID 1 --env_name maze2d-large-v1 --plot --mode pi --device cuda:1
# python train_reference_v2.py --ExpID 100 --env_name maze2d-large-v1 --plot --mode v --device cuda:0 --load_model 3